...
<body>
    ...
    <section class="projects" id="projects">
        ...
        <div class="projects-content">
            <div class="row">
                ...
                <p>Mobile app landing design & Services</p>
            </div>
    ...
    <section class="about" id="about">
        ...
        <div class="about-text">
            ...
            <p>A self taught junior web developer based near London. I bring a range of skills from visual design,
                interaction design, UX, to prototyping. I'm always looking for creative people to vibe with, let's
                connect through my social channels below. My interest lies in solving problems. I love spending time on
